...
$stmt = $conn->prepare("SELECT `staff_ID`, `staff_Name`, `email`, `status`, `department` FROM `staff` WHERE `department` = ? ORDER BY `staff`.`status` ASC ,`staff_ID`"); // Adjust column names based on your table
